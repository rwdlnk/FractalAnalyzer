...
def analyze_resolution_convergence(base_dir, target_time=5.0, 
	...
	use_grid_optimization=False, min_box_size=None):
    ...
    if len(df) >= 3:
        results_summary = alternative_convergence_analysis(df, target_time, output_dir)
...
def alternative_convergence_analysis(df, target_time, output_dir):
    """
...
def main():
    ...
    results = analyze_resolution_convergence(args.base_dir, args.time, args.output, args.mixing_method, args.h0,
	           use_grid_optimization, args.min_box_size)
